      ...
      <div className="max-w-[var(--max-width)] mx-auto px-page py-3">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-3 shrink-0">
            {/* Replaced border-gray-300 → border-border, added hover states */}
            <button className="flex items-center px-3 py-2 text-sm font-inter text-secondary border border-border rounded-2xl hover:bg-bg-hover hover:text-primary transition-colors duration-200">
